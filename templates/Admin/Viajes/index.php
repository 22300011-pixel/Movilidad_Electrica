...
<div class="viajes index content">
    <?= $this->Html->link(__('Nuevo Viaje'), ['action' => 'add'], ['class' => 'button float-right']) ?>
    <h3><?= __('Viajes') ?></h3>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('Ver'), ['action' => 'view', $viaje->id]) ?>
                        <?= $this->Html->link(__('Editar'), ['action' => 'edit', $viaje->id]) ?>
                        <?= $this->Form->postLink(
                            __('Eliminar'),
